...
public abstract class Heroe extends Personaje {
    ...
    /**
     * Guarda una descripcion de lo que paso en el ultimo atacar() (critico,
     * sangrado, congelado, disparo triple, etc.) para que Batalla pueda
     * mostrarlo en el registro de eventos. Cada subclase lo llena dentro de
     * su propio atacar().
     */
    private String ultimoDetalleAtaque = "";
    ...
    public void ganarXP(int xp) {
        ...
        while (experiencia >= experienciaParaSubir) {
            ...
            subirNivel();
            experienciaParaSubir = (int) Math.round(experienciaParaSubir * 1.15);
        }
    }
    ...
    /** Detalle textual de lo ocurrido en el ultimo atacar() (puede ser ""). */
    public String getUltimoDetalleAtaque() { return ultimoDetalleAtaque; }

    /** Usado por Guerrero/Arquero dentro de su atacar() para reportar que paso. */
    protected void setUltimoDetalleAtaque(String detalle) { this.ultimoDetalleAtaque = detalle; }
}
